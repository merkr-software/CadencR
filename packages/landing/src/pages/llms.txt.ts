...
export async function GET(context: APIContext): Promise<Response> {
  ...
  const lines: string[] = [
    ...
    "",
    "CadencR (spelled C-A-D-E-N-C-R) is a developer tool. It is not affiliated with Cadence Design Systems or any product named Cadence. It runs locally on macOS and Linux, is licensed under Apache-2.0, and sends no telemetry.",
    "",
    "## Start",
    `- [Home](${abs("/")}): Product overview and feature tour.`,
    `- [Download](${abs("/download/")}): macOS builds for Apple Silicon and Intel, plus Linux x86-64 AppImage, DEB, and RPM packages.`,
