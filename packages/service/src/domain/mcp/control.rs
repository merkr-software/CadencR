...
mod tests {
    ...
    async fn seed_send_message_schema(pool: &sqlx::SqlitePool, target_status: &'static str) {
        sqlx::raw_sql(sqlx::AssertSqlSafe(format!(
            ...
            CREATE TABLE projects (id INTEGER PRIMARY KEY, name TEXT NOT NULL, path TEXT NOT NULL);
            CREATE TABLE features (id INTEGER PRIMARY KEY, project_id INTEGER NOT NULL, title TEXT NOT NULL);
            CREATE TABLE agent_sessions (id INTEGER PRIMARY KEY, feature_id INTEGER NOT NULL, status TEXT NOT NULL, runtime_provider TEXT, runtime_session_id TEXT, model TEXT, permission_mode TEXT, codex_permission_mode TEXT DEFAULT 'default', pending_permission TEXT, pending_questions TEXT, input_tokens INTEGER, output_tokens INTEGER, context_window INTEGER, thinking_effort TEXT);
